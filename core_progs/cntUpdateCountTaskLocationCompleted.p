/*------------------------------------------------------------------------------------------------------------------------------------------
Program : cntUpdateCountTaskLocationCompleted.p
Purpose : Updates the CountTaskLocation Completed Field and status of Complete
...
DO ON STOP UNDO, RETRY:
   ...
   DO ON ERROR UNDO:
      ...
      IF CountTaskLocation.AssignedTo <> intGblUserID THEN
      DO:
      ...
      updCountTaskLocation:assignField("CountTaskStatusID", fGetStatusID("CountTask", "Complete")).
