/*------------------------------------------------------------------------------------------------------------------------------------------
Program : bldCheckParentExistsForWorkOrder.p 
...
DO ON STOP UNDO, RETRY:
   ...
   DO ON ERROR UNDO:
      ...
      FOR EACH  otherkittedUnit NO-LOCK 
         ...
         AND   otherkittedUnit.WorkOrderID    =  KittedUnit.WorkOrderID :
      ...
      DO:     
         ...
         intSsnStockPackageID:setValue(parentStockPackage.StockPackageID).               
          
         /* Proceed to scan and verify parent screen */
         chrResult = "Yes".
