/*------------------------------------------------------------------------------------------------------------------------------------------
Program : cntUpdateLocationInProcessCount.p
Purpose : Updates the Location to be count in process for a Count Task
...
/*      IF Location.CountInProcess = TRUE THEN                                                                           */
/*      DO:                                                                                                              */
/*         RUN DisplayError("Count In Process",                                                                          */
/*                          "[Location ID] [" + STRING(intSsnLocationID:intValue) + "] already has a count in process.").*/
/*         LEAVE Main_Block.                                                                                             */
/*      END.                                                                                                             */
      ...
      updLocation:assignField("CountInProcess", TRUE).
